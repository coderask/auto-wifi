...
struct PermissionOnboardingView: View {
    ...
    var body: some View {
        VStack(spacing: 24) {
            ...
            Text("If the macOS Location prompt does not appear, grant access manually in System Settings → Privacy & Security → Location Services. (TCC sometimes suppresses the prompt for ad-hoc-signed builds; once notarized, the prompt will appear automatically.)")
                .font(.caption)
